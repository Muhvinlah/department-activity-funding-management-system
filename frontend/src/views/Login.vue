<template>
  <div class="h-screen xl:grid grid-cols-3 overflow-hidden">
    ...
    <div class="hidden xl:flex flex-col bg-[#0d7d90] text-[#f6f5f4]">
      <div class="flex place-items-center px-5 py-3">
        <img src="../assets/campus.png" alt="Campus Logo" class="h-16">
        <div><h2 class="text-base ml-2">Politeknik Negeri Jakarta (PNJ)</h2></div>
      </div>

      <div class="mt-32 self-center">
        <img src="../assets/Logo.png" alt="System Icon" class="h-80">
      </div>

      <div class="text-center text-4xl font-bold">
        <h1>Sistem Manajemen</h1>
        <h2>Pengelolaan Dana</h2>
        <h3>Kegiatan Jurusan</h3>
      </div>
    </div>

    <!-- Right Side Content -->
    <div class="shapedividers_com-478 bg-[#f6f5f4] col-span-2 h-screen justify-center flex">
      <div class="flex flex-col justify-center items-center w-1/2">
        ...
        <form @submit.prevent="handleStandardLogin" class="w-full max-w-md">
          ...
          <div class="lg:flex space-y-5 justify-around mb-4">
            <div>
              <button
                type="submit"
                :disabled="isLoading"
