      ...
      <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-200 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="text-center p-4 bg-green-50 rounded-lg">
            ...
            <p class="text-xs text-green-600 mt-1">{{ ((budget.used / budget.total) * 100).toFixed(1) }}% dari total</p>
          </div>
          ...
          <div class="text-center p-4 bg-orange-50 rounded-lg">
            ...
            <p class="text-xs text-orange-600 mt-1">{{ ((budget.available / budget.total) * 100).toFixed(1) }}% dari total</p>
          </div>
        </div>
...
// User data - in real app, this would come from auth store
const user = ref({
  role: 'student' // student, admin, secretary, department_chair
})
...
onMounted(() => {
  ...
  // In real app, fetch statistics from API
